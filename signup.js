...
This code can be used to log in to your website account. We never ask for it for anything else.
...
function verifyCode() {
    ...
    if (enteredCode === storedCode) {
        ...
        // Check if the current user is the owner (Owner ID: 5123439510)
        let telegramId = localStorage.getItem("telegramId");
        if (telegramId === "5123439510") {
            // Redirect to admin page if owner
...
function toggleMessage() {
    ...
    const isVisible = helpMessage.style.display === 'block';
...
function saveAccount() {
    ...
    // Check if the user is the owner and redirect to admin page if true
    if (telegramId === "5123439510") {
        window.location.href = "admin.html"; // Redirect to admin page for owner
    } else {
